...
function EditProfile() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://localhost:8000/artist/editProfile', data);
            navigate("/");
                                ...
                                <div className="card mb-3" style={{ borderRadius: '10px' }}>
                                    <div className="row g-0">
                                        <div className="card-body p-4">
                                            ...
                                            <hr />
                                            <form onSubmit={handleSubmit} encType='multipart/form-data' className="row col-lg-12">
                                                ...
                                                <div className="row col-lg-12">
                                                    <div className="col-lg-6 mb-3">
                                                        <h6>Phone</h6>
                                                        <input type="tel" className="form-control" name="phoneNo" value={userData.phoneNo} onChange={handleInputChange} />
                                                    </div>
                                                    <div className="col-lg-6 mb-3">
                                                ...
                                                <div className="row col-lg-12">
                                                    <div className="col-lg-6 mb-3">
                                                        <h6>Address</h6>
                                                        <textarea rows={"2"} type="text" className="form-control" name="address" value={userData.address} onChange={handleInputChange} />
                                                    </div>
                                                    <div className="col-lg-6 mb-3">
                                                        ...
                                                        <input type="file"
                                                            ...
                                                            accept="image/*" required style={{ marginTop: "15px" }} />
                                                    </div>
                                                </div>
                                                <div className="row col-lg-12">
                                                    <div className="col-lg-6 mb-3">
